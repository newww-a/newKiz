...
import ArticleDetailModal from '@/widgets/reporter/ui/ArticleDetailModal';
        ...
        <div className="pt-2 pb-20 ">
            {reporterNewsList.map((news) => (
                <div key={news.id}>
                    ...
                    <div className="bg-gray-200 w-auto h-80 flex items-center justify-center cursor-pointer" onClick={() => openModal(news)}>
                        뉴스와 관련된 사진
                    </div>
