    ...
    <div className="mt-3">
      ...
      >
        {relatedNews.map((item, idx) => (
           ...
           <div className="flex flex-col justify-between bg-white border-2 border-[#EBEBEB] h-[180px] w-[180px] p-2 rounded-lg cursor-pointer">
             <div className="text-[#BFD46F] font-bold texxt-[20px]">{idx+1}</div>
             <div className="font-semibold text-[16px] clamp-3 mx-1 mt-0">{item.title}</div>
