    ...
    <div className="w-full h-full flex flex-col items">
      ...
      <div className="w-full flex flex-row items-center justify-center mt-3">
        <div className="w-[90%] flex flex-col justify-center items-center font-semibold">
          <div className="w-full py-3 flex flex-row justify-between items-center cursor-pointer" onClick={()=>navigate("/mypage/summary")}>
          ...
          <div className="w-full py-3 flex flex-row justify-between items-center cursor-pointer" onClick={()=>navigate("/mypage/wronganswer")}>
            <div className="flex flex-row items-center gap-5">
          ...
          <div className="w-full py-3 flex flex-row justify-between items-center cursor-pointer" onClick={() => navigate("/mypage/scrap")}>
            <div className="flex flex-row items-center gap-5">
          ...
          <div className="w-full py-3 flex flex-row justify-between items-center cursor-pointer" onClick={() => navigate("/mypage/info")}>
            <div className="flex flex-row items-center gap-5">
