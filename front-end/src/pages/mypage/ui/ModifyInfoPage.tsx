    ...
    <div className="w-full flex flex-col mt-5">
      ...
      <div className="flex flex-col items-center w-full gap-3">
        ...
        <div className="flex flex-col items-start w-full px-3 gap-2">
          ...
          <select defaultValue="남자" className="border border-gray-200 w-full h-10 rounded-lg px-3 bg-white focus:outline-none focus:ring-2 focus:ring-[#7CBA36] focus:border-transparent">
