...
export default function CategoryPage() {
  ...
  const newsItems: NewsItem[] = [
    {
      ...
      category: 'sports',
      subCategory: 'soccer',
      imageUrl: 'https://newkiz.s3.ap-northeast-2.amazonaws.com/news/soccer-news-1.jpg',
    ...
    },
    {
      ...
      imageUrl: 'https://newkiz.s3.ap-northeast-2.amazonaws.com/news/baseball-news-1.jpg',
      description: 'AI를 통해 한줄 요약 내용'
    },
    {
      id: '3',
      ...
      category: 'sports',
      subCategory: 'soccer',
      imageUrl: 'https://newkiz.s3.ap-northeast-2.amazonaws.com/news/soccer-news-2.jpg',
      description: 'AI를 통해 한줄 요약 내용'
    },
    {
      id: '4',
      title: '경제 회복세 전망...',
      category: 'economy',
      imageUrl: 'https://newkiz.s3.ap-northeast-2.amazonaws.com/news/economy-news-1.jpg',
      description: 'AI를 통해 한줄 요약 내용'
    }
  ];
  ...
  return (
    <Layout>
      {/* 카테고리 탭 바 */}
      <div className="flex overflow-x-auto bg-[#e4edab] py-2 px-4 sticky top-0 z-10 shadow-sm">
